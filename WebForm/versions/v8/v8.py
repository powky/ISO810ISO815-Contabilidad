...
class Ui_TabWidget(QtCore.QObject):
    ...
    def filter_acctype(self):
        ...
        acctype_filter_orig = self.acctypeOrgTxt.toPlainText().strip()
        acctype_filter_status = self.acctypeStsTxt.toPlainText().strip()
    ...
    def filter_currency(self):
        ...
        currency_filter_status = self.currencyStsTxt.toPlainText().strip()
    ...
    def filter_aux(self):
        ...
        aux_filter_status = self.auxStatusTxt.toPlainText().strip()
    ...
    def update_acctype(self):
        ...
        updated_orig = self.acctypeOrgTxt.toPlainText().strip()
        updated_status = self.acctypeStsTxt.toPlainText().strip()
    ...
    def update_currency(self):
        ...
        updated_status = self.currencyStsTxt.toPlainText().strip()
    ...
    def update_aux(self):
        ...
        updated_status = self.auxStatusTxt.toPlainText().strip()
