...
class Ui_TabWidget(QtCore.QObject):
    ...
    def filter_accounting_accs(self):
        ...
        # Almacenar las variables de la fila seleccionada
        ...
        # Empezar construcción del query
        ...
        # Añadir filtros si un campo tiene datos
        ...
        # Consumir la base de datos con el query finalizado
        cursor = self.connection.cursor()
        ...
        # Si ya tengo un filtro activo, para poder borrar el filtro
    ...
    def filter_entries(self):
        ...
        # Llenar diccionario aux_mapping usando la tabla aux_systems
        cursor = self.connection.cursor()
        ...
        # Llenar diccionario accaccs_mapping usando la tabla accounting_accs
        cursor = self.connection.cursor()
    ...
    def update_accounting_data(self):
        # Almacenar en variables la fila seleccionada
        ...
        # Almacenar en variables los campos de texto escritos
        ...
        # Comparar los campos de la fila contra los campos escritos para ver si algunos ha cambiado
        ...
        try:
            ...
            # Añadir al query los campos distintos a actualizar
            ...
            update_query = update_query.rstrip(", ") # Eliminar la última coma del query
            update_query += " WHERE id = :id" # Añadir el WHERE por ID
            update_params["id"] = row_id # Añadir el ID al diccionario de parámetros del query
            ...
            self.connection.commit()
            cursor.close()
            QMessageBox.information(None, "Completado", "¡Se actualizaron los datos exitosamente!") # Mensaje de éxito en pantalla
            self.clear_text_fields() # Llamar función que limpia campos de texto del UI
            self.query_accounting_accs() # Llamar función de SELECT de la tabla para refrescar la tabla del UI

        # Excepción si no logra correr el query
        except Exception as e:
    ...
    def update_acctype(self):
        ...
        try:
            ...
            QMessageBox.information(None, "Completado", "¡Se actualizaron los datos exitosamente!") # Mensaje de éxito en pantalla
            self.clear_text_fields() # Llamar función que limpia campos de texto del UI
            self.query_acctypes() # Llamar función de SELECT de la tabla para refrescar la tabla del UI
    ...
    def update_currency(self):
        ...
        try:
            ...
            QMessageBox.information(None, "Completado", "¡Se actualizaron los datos exitosamente!") # Mensaje de éxito en pantalla
            self.clear_text_fields() # Llamar función que limpia campos de texto del UI
            self.query_currency() # Llamar función de SELECT de la tabla para refrescar la tabla del UI
    ...
    def update_aux(self):
        ...
        try:
            ...
            QMessageBox.information(None, "Completado", "¡Se actualizaron los datos exitosamente!") # Mensaje de éxito en pantalla
            self.clear_text_fields() # Llamar función que limpia campos de texto del UI
            self.query_auxsys() # Llamar función de SELECT de la tabla para refrescar la tabla del UI
    ...
    def update_entries(self): 
        ...
        try:
            ...
            QMessageBox.information(None, "Completado", "¡Se actualizaron los datos exitosamente!") # Mensaje de éxito en pantalla
            self.clear_text_fields() # Llamar función que limpia campos de texto del UI
            self.query_entries() # Llamar función de SELECT de la tabla para refrescar la tabla del UI
    ...
    def update_button_enabled(self):
        ...
        # Activa o desactiva los botones basados en la condición de que todos o algunos deben tener datos
        ...
        # Mapeo de botones dependiendo el diccionario que contiene
    ...
    def on_table_item_clicked(self, item, table):
        ...
        # Si todos los registros previos son igual a los actuales, indica que quiere deseleccionar
    ...
    def clear_text_fields(self):
        ...
        # Sencillamente a todos los campos le borramos el dato actual
    ...
    def is_id_in_table(self, table, id_value):
        # Ciclar sobre las filas de la tabla seleccionada
        for row in range(table.rowCount()):
            table_item = table.item(row, 0)  # El ID siemore será el primer campo
            if table_item is not None and table_item.text() == id_value:
                return True  # Si el ID está en la tabla, retornamos true
        return False  # Si el ID no está en la tabla, retornamos false

def handle_row_deselected():
    # Borra los datos del diccionario de selección pasada
    ui.previous_selected_row = None
...
if __name__ == "__main__":
    ...
    # Cargamos todos los SELECT iniciales
